            ...
            <Credentials>
              <form
                ...
                <div className="mt-10 w-full flex justify-center items-center flex-col">
                  <input
                  className={`bg-transparent border-b-[1px] border-black font-syncopate-light outline-none p-2 text-lg text-white placeholder:text-[rgb(107,102,109)] w-auto ${errors.email ? 'is-invalid' : ''} dark:placeholder:text-[#fff] dark:border-white`}
                    type="email"
                    name="email"
                    id="email"
                    placeholder="Email *"
